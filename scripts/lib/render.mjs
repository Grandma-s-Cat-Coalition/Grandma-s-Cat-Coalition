...
function footer(s) {
  return `<footer class="site-footer" data-footer><div class="wrap footer-grid"><div class="footer-brand"><h2>${esc(s.orgName)}</h2><p class="tagline">One cat at a time, we’re making a kinder future for community cats.</p><p class="address">📍 ${esc(s.address).replace(/, /, '<br>')}</p><p class="contact-links"><a href="${tel(s.phone)}">☎ ${esc(s.phone)}</a><a href="mailto:${esc(s.email)}">✉ ${esc(s.email)}</a></p><div class="social-links" aria-label="Social media"><span>Follow our work</span><a href="${esc(s.facebook)}" aria-label="Grandma's Cat Coalition on Facebook">f</a><a href="${esc(s.facebook)}" aria-label="Grandma's Cat Coalition on Instagram">◎</a></div></div><nav class="footer-menu" aria-label="Footer menu"><h2>Get involved</h2><a href="/adopt.html">🐱 <span>Adopt a cat</span></a><a href="/foster.html">🏡 <span>Foster a cat</span></a><a href="/volunteer.html">🤝 <span>Volunteer</span></a><a href="/donate.html">💜 <span>Donate</span></a></nav><div class="footer-newsletter"><h2>Stay in the loop</h2><p>Occasional updates on cats, events, and ways to help. No spam, ever.</p>${newsletterForm('newsletter-email-footer')}</div></div><div class="footer-bottom"><p>${esc(s.orgName)} is a 501(c)(3) nonprofit. Donations are tax-deductible.</p><nav aria-label="Legal"><a href="/privacy.html">Privacy</a><a href="/terms.html">Terms</a></nav></div></footer>`;
}
