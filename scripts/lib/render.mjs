...
function header() {
  return `<header class="site-header" data-header><div class="wrap nav"><a class="brand" href="/" aria-label="Grandma's Cat Coalition home"><img src="/images/brand/gcc-logo.png" alt="" width="1254" height="1254"><span class="brand-copy"><strong><span class="brand-grandma">Grandma's</span> Cat Coalition</strong><small>Where Second Chances Become Forever Homes.</small></span></a><button class="menu" aria-expanded="false" aria-controls="nav-links" aria-label="Open menu">☰</button><nav id="nav-links" class="nav-links" aria-label="Main"><a href="/adopt.html">Adopt</a><a href="/foster.html">Foster</a><a href="/volunteer.html">Volunteer</a><a href="/tnr.html">TNR</a><a href="/about.html">About</a><a href="/team.html">About the team</a><a href="/news.html">News</a>${actionButton('donate','DONATE NOW','/donate.html','donate')}</nav></div></header>`;
}

function footer(s) {
  return `<footer class="site-footer" data-footer><div class="wrap footer-grid"><div class="footer-brand"><h2>${esc(s.orgName)}</h2><p class="tagline">Where Second Chances Become Forever Homes.</p><p class="address">${iconSvg('pin')}<span>${esc(s.address)}</span></p><p class="contact-links"><a href="${tel(s.phone)}">${iconSvg('phone')}<span>Call or Text Us!</span></a><a href="mailto:${esc(s.email)}">${iconSvg('envelope')}<span>Email Us!</span></a></p><div class="social-links" aria-label="Social media"><span>Follow our work</span><a href="/" aria-label="Grandma's Cat Coalition home">⌂</a><a href="/news.html" aria-label="Grandma's Cat Coalition news">✦</a><a href="${esc(s.facebook)}" aria-label="Grandma's Cat Coalition on Facebook">f</a></div></div><nav class="footer-menu" aria-label="Footer menu"><h2>Get involved</h2><a href="/adopt.html"><span class="footer-icon">${iconSvg('paw')}</span><span>Adopt a cat</span></a><a href="/foster.html"><span class="footer-icon">${iconSvg('house')}</span><span>Foster a cat</span></a><a href="/volunteer.html"><span class="footer-icon">${iconSvg('people')}</span><span>Volunteer</span></a><a href="/donate.html"><span class="footer-icon">${iconSvg('donate')}</span><span>Donate</span></a></nav><div class="footer-newsletter"><h2>Stay in the loop</h2><p>Occasional updates on cats, events, and ways to help. No spam, ever.</p>${newsletterForm('newsletter-email-footer')}</div></div><div class="footer-bottom"><p>${esc(s.orgName)} is a 501(c)(3) nonprofit. Donations are tax-deductible.</p><nav aria-label="Legal"><a href="/privacy.html">Privacy</a><a href="/terms.html">Terms</a></nav></div></footer>`;
}
