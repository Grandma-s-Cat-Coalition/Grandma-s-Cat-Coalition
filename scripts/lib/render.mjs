...
function header() {
  return `<header class="site-header" data-header><div class="wrap nav"><a class="brand" href="/" aria-label="Grandma's Cat Coalition home"><img src="/images/brand/gcc-logo.png" alt="Grandma's Cat Coalition" width="1254" height="1254"></a><button class="menu" aria-expanded="false" aria-controls="nav-links" aria-label="Open menu">☰</button><nav id="nav-links" class="nav-links" aria-label="Main"><a href="/adopt.html">Adopt</a><a href="/foster.html">Foster</a><a href="/volunteer.html">Volunteer</a><a href="/tnr.html">TNR</a><a href="/about.html">About</a><a href="/team.html">About the team</a><a href="/news.html">News</a>${actionButton('donate','DONATE NOW','/donate.html','donate')}</nav></div></header>`;
}
